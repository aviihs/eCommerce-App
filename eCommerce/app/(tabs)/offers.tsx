    ...
    <SafeAreaView className="flex-1 bg-gray-100">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <TouchableOpacity className="mt-4 px-4" activeOpacity={0.6}>
          <Image
            source={require("@/assets/free-delivery-visual-ecommerce-social-260nw-2681743255.jpg")}
        ...
        <TouchableOpacity className="mt-4 px-4" activeOpacity={0.6}>
          <Image
            source={require("@/assets/promo-code-gift-voucher-with-coupon-code-premium-egift-card-background-e-commerce-online-shopping-marketing-illustration_100456-1619.jpg")}
